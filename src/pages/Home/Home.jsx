...
function Home() {
  ...
  const services = [
    {
      ...
      description: "We create bespoke software solutions tailored to your specific business needs, from web and mobile applications to complex enterprise systems."
    },
    {
      icon: <FaChartLine />,
      title: "AI and Machine Learning",
      description: "Harness the power of AI with our advanced analytics and automation solutions."
    },
    {
      icon: <FaCloud />,
      title: "Cloud Solutions",
      description: "Scalable and secure cloud-based solutions for businesses of all sizes. Our services include cloud migration, infrastructure setup, and ongoing management."
    },
    {
      icon: <FaCogs />,
      title: "ERP Systems",
      description: "Streamline your operations with our comprehensive ERP solutions. We offer modules for finance, HR, supply chain, and more, tailored to your industry."
    },
    // {
    //   icon: <FaDatabase />,
  ...
  const products = [
    ...
    },
    {
      ...
      description: "Comprehensive asset tracking tool, enabling efficient resource monitoring with real-time updates and alerts.",
      keyPoints: [
    ...
    },
    {
      ...
      description: "A robust CRM system offering tailored solutions to improve customer service and foster growth.",
      keyPoints: [
    ...
    },
    {
      ...
      description: "Easy-to-use booking platform for managing reservations with secure, flexible scheduling options.",
      keyPoints: [
    ...
    <>
      ...
      >
        <div className="hero-content">
          ...
          <div className="cta-buttons">
            ...
            <button className="cta-button secondary" onClick={() => navigate('/services')}>Our Services</button>
          </div>
        </div>
      </section>
      ...
      style={{ backgroundImage: `url(${homeBackground})` }}>
        ...
        <div className="services-buttons">
          ...
          <button className="services-button secondary" onClick={() => navigate('/contact')}>
            Get a Quote
          </button>
        </div>
      </section>
